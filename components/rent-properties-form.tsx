...
import PropertyCard2Last from "./property-card2-last";
    ...
    <div className="self-stretch flex flex-col items-center justify-start py-[86px] px-0 gap-[39px] text-center text-21xl text-primary-800 font-body-regular-600">
      <div className="self-stretch flex flex-col items-center justify-start gap-[40px] max-w-[95%px]">
        ...
        <div className="self-stretch flex flex-row flex-wrap items-start justify-center gap-[40px] text-left text-base text-gray-white">
          <PropertyCard2Last />
          <PropertyCard2Last propBackgroundImage="url('/card-21@3x.png')" />
          <PropertyCard2Last propBackgroundImage="url('/card-31@3x.png')" />
          <PropertyCard2Last propBackgroundImage="url('/card-41@3x.png')" />
        </div>
      </div>
